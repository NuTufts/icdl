#ifndef gallery_SubRunDataGetterHelper_h
#define gallery_SubRunDataGetterHelper_h
...
namespace gallery {
  ...
  class SubRunDataGetterHelper : public art::PrincipalBase {
  public:
    explicit SubRunDataGetterHelper(
      SubRunNavigator const* eventNavigator,
      std::shared_ptr<SubRunHistoryGetter> historyGetter);

    SubRunDataGetterHelper(SubRunDataGetterHelper const&) = delete;
    SubRunDataGetterHelper(SubRunDataGetterHelper&&) = delete;
    SubRunDataGetterHelper& operator=(SubRunDataGetterHelper const&) = delete;
    SubRunDataGetterHelper& operator=(SubRunDataGetterHelper&&) = delete;
  ...
  private: // MEMBER DATA
    ...
    std::shared_ptr<SubRunHistoryGetter> historyGetter_;
...
#endif /* gallery_SubRunDataGetterHelper_h */
